...
export default function MobileNavbar({ onNavigate, onLogin, onSignUp, onMember }: MobileNavbarProps) {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 shadow-lg">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className="flex flex-col items-center justify-center p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors min-w-[60px]"
              >
